            ...
            <div className="section-container">
                ...
                <div className="pricing-grid">
                    <div className="pricing-card">
                        ...
                        <Link href="#" className="pricing-btn">Get Started</Link>
                    </div>
                    <div className="pricing-card featured" id="proCard">
                        <div className="pricing-name">Pro</div>
                        <div className="pricing-price">
                            <span className="currency">$</span>
                            <span id="proPrice" style={{ transition: 'all 0.15s ease' }}>{plan.priceDisplay}</span>
                            <span className="period">/mo</span>
                        </div>
                        <div className="pricing-billed" id="proBilled">{plan.billed}</div>
                        <div className="pricing-savings" id="proSavings">{plan.savings}</div>
                        ...
                        <Link href="#" className="pricing-btn">Start Free Trial</Link>
                    </div>
                    <div className="pricing-card">
                        ...
                        <Link href="#" className="pricing-btn">Get Lifetime Access</Link>
                    </div>
                </div>
            </div>
        </section>
